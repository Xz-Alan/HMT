...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1):
        ...
        # 1 x 1 conv-BN --> compress channels
    ...
    def forward(self, x):
        ...
        residual = x
        # reduce the channel inplane --> planes
        out = self.conv1(x)
        out = self.bn1(out)
        out = self.relu(out)
        # 3 x 3 conv
...
class ResNet(nn.Module):
    def __init__(self, block, layers=(3, 4, 23, 3)):
        ...
        # intput --> [conv1-bn1-relu] --> pooling --> residual block
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1):
        downsample = None
        # ensure the in_channels == out_channels
